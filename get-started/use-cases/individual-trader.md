---
description: 了解個人交易者的痛點以及如何添加 BlockRazor RPC 到錢包，根據需求選擇不同模式RPC進行添加
metaLinks:
...
{% step %}
點擊 Add custom network，輸入[網絡信息](individual-trader.md#tong-yong-rpc-wang-luo-xin-xi)
