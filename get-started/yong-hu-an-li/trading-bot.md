...
[Fast](../../transaction-submission/fast/)：利用 [BEF](../../he-xin-ji-shu/blockchain-edge-fabric.md) 和高質押驗證者的SWQoS鏈路實現交易最低延遲上鏈。
...
[Bundle](../../transaction-submission/rpc/bsc/eth_sendmevbundle/)：在監聽到開盤交易後，Trading Bot可以利用Bundle讓狙擊交易緊貼在開盤交易後上鏈，幫助用戶抹平由於上鏈延遲導致的價格波動風險。
