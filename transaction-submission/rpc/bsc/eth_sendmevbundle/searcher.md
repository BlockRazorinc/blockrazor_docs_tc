...
Searcher可以訂閱 [Private Mempool ](../../../../streams/mempool/bsc/private-mempool.md)執行backrun策略，再將[backrun bundle](searcher.md#qing-qiu-shi-li)發送至BlockRazor RPC參與競拍獲得收益。
