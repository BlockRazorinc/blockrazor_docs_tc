---
description: 介紹BlockRazor Block Builder的Fast Submit以及接入方式
---
...
經測試，Fast Submit 相比普通提交通道可顯著降低提交鏈路延遲。

在跨洋線路中延遲可降低約 50 ms，在 BSC 當前約 450 ms 的出塊時間下，交易的 0 block 上鏈率可提升約 11%。若未來出塊時間進一步降至 250 ms，該提升幅度可擴大至約 20%。

在內陸線路中延遲可降低約 20 ms，在當前出塊時間下，交易的 0 block 上鍊率可提升約 4.4%，若未來出塊時間降至 250 ms，提升幅度可進一步擴大至約 8%。
