...
`Send Transaction` 用於在Solana上發送已簽名的交易，支持HTTP協議。與 [Send Transaction](send-transaction/) 方式相比，它提供了一種更精簡、更迅速的交易提交途徑。
...
`Send Transaction v2` 的以上特性更適合擁有全球用戶的前端交易應用項目。

### 端點

{% tabs %}
{% tab title="HTTP" %}
<table data-search="false"><thead><tr><th width="108.7109375">地區</th><th>端點</th></tr></thead><tbody><tr><td>法蘭克福</td><td>http://frankfurt.solana.blockrazor.xyz:443/v2/sendTransaction</td></tr><tr><td>法蘭克福</td><td>http://frankfurt-allnodes.solana.blockrazor.xyz:443/v2/sendTransaction</td></tr><tr><td>法蘭克福</td><td>http://frankfurt-cherryservers.solana.blockrazor.xyz:443/v2/sendTransaction</td></tr><tr><td>紐約</td><td>http://newyork.solana.blockrazor.xyz:443/v2/sendTransaction</td></tr><tr><td>東京</td><td>http://tokyo.solana.blockrazor.xyz:443/v2/sendTransaction</td></tr><tr><td>阿姆斯特丹</td><td>http://amsterdam.solana.blockrazor.xyz:443/v2/sendTransaction</td></tr><tr><td>阿姆斯特丹</td><td>http://amsterdam-cherryservers.solana.blockrazor.xyz:443/v2/sendTransaction</td></tr><tr><td>倫敦</td><td>http://london.solana.blockrazor.xyz:443/v2/sendTransaction</td></tr><tr><td>多倫多</td><td>http://toronto.solana.blockrazor.xyz:443/v2/sendTransaction</td></tr><tr><td>新加坡</td><td>http://singapore.solana.blockrazor.xyz:443/v2/sendTransaction</td></tr><tr><td>洛杉磯</td><td>http://losangeles.solana.blockrazor.xyz:443/v2/sendTransaction</td></tr></tbody></table>
{% endtab %}
