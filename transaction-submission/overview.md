...
Transaction Sending 是 Transaction Submission 中的“速度優先”模式，適用於對上鏈時延高度敏感的場景。它通過 [BEF](../he-xin-ji-shu/blockchain-edge-fabric.md) 讓交易在更短時間窗口內觸達出塊節點。
