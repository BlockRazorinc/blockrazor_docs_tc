---
description: 瞭解 BlockRazor BSC Block Stream的服務、應用場景、Benchmark、價格、端點以及集成方法
metaLinks:
...
# BSC NewBlocks Stream API

<details>

<summary><strong>BSC NewBlocks是什麼</strong></summary>
...
<summary><strong>BSC NewBlocks的應用場景</strong></summary>
