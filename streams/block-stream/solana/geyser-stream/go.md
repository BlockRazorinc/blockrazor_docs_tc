---
description: 使用 Go 示例通過 BlockRazor 訂閱 Solana Geyser Stream，查看代碼示例
metaLinks:
  canonical: go.md
  alternates:
    - >-
      https://app.gitbook.com/s/jbyfG8gOgcdsK3wVxNdQ/streams/block-stream/solana/geyser-stream/go
---

# Solana Geyser Stream Go 訂閱示例
