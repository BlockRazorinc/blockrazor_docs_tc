...
* [**Private Mempool**](/broken/pages/NXkreaYlqBUKcNyRE5Zf)**:** 用於訂閱私有訂單流數據，適合 backrun等場景
...
[Node Stream](node-stream/bsc/quan-jie-dian-tong-bu.md) 用於低延遲同步最新區塊和 world state，適合依賴本地節點狀態進行決策的系統。
